    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-auto">
          ...
          >
            <li className="mb-6 ms-6 px-5 lg:w-3/5 ">
              ...
              <p className="mb-4 pl-10 text-base font-normal text-gray-500 dark:text-gray-400">
                Building a DaaS (Decision as a Service) Platform for US
                Healthcare using LLM models to generate effective decisions
              </p>
            </li>
            <li className="mb-6 ms-6 px-5 lg:w-3/5">
              <span className="absolute  flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
              ...
              <p className="text-base pl-10 font-normal text-gray-500 dark:text-gray-400">
                Worked on Affiliate Tracking System to keep track of the links
                which led to 3x more efficient revenue prediction.
              </p>
            </li>
            <li className="ms-6 px-5 lg:w-3/5">
              ...
              <p className="text-base pl-10 font-normal text-gray-500 dark:text-gray-400">
                Contributed to the community by building various projects on
                Web, Android & Machine Learning. Taught python to 150+ students
                of our college.
              </p>
            </li>
          </ol>
        ...
        >
          ...
          <a href="./Resume-dipayan.pdf" download>
            Download CV
          </a>
        </div>
      </div>
